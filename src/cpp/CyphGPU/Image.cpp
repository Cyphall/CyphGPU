...
cgpu::SampledImageHandle cgpu::Image::getSampledDescriptor(const SampledDescriptorOverrides& overrides)
{
...
cgpu::StorageImageHandle cgpu::Image::getStorageDescriptor(const StorageDescriptorOverrides& overrides)
{
